    ...
    public void OnClickCharacter(string characterId)  // 버튼 클릭 시 실행될 함수 (각 캐릭터 버튼에 이 함수 연결함)
    {
        ...
        switch (characterId)
        {
            case "Edwin":
                ...
                descriptionText.text = "마을을 수호하던 기사 출신의 남성. \n은퇴를 하며 기사 생활을 접고 마을 외딴 곳에 작은 대장간을 차렸다. \n대장장이로서 새롭게 삶을 시작한 이 남자는 세계제일의 대장장이를 꿈꾸며 \n오늘도 열심히 망치를 두들긴다.";
            ...
            case "Isabella":
                ...
                descriptionText.text = "평생 대장장이의 삶을 살았던 아버지의 강요로 원치 않는 가업을 물려받은 아리따운 외모를 가진 소녀.퉁명스럽고 불량한 태도, 만사 귀찮아 하고 하기 싫어하는 그녀에게 축복 받은 행운이 있다는 사실을 그녀 빼고 모든 마을 사람들이 알고 있다.";
                statsText.text = "능력\n초심자의 행운 : 제작 성공 시, 손님의 만족도 상관 없이 보상을 추가로 받는다.\n섬세한 손놀림 : 제작 시 발동되는 미니게임의 판정을 좋게 바꿔준다.\n가녀린 손목 : 일상 도구 이외의 장비는 제작할 수 없다.";
                break;

            case "Tusk":
                characterImageDisplay.sprite = tuskSprite;
                nameText.text = "터스크 (Tusk)";
                descriptionText.text = "전 세계 몇 명 밖에 없는 그랜드 마스터라는 칭호를 보유하고 있는 베테랑 명장. 모든 것을 만들 수 있지만, 반대로 고집이 세 자신의 철학에 이의를 제기하는" +
                    " 잔챙이들을 매우 싫어한다. 시간이 지나면 대장간을 처분하고 소리소문 없이 사라진다고 한다. 자세한 이유는 아무도 모른다고 한다.";
